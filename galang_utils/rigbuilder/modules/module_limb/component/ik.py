    ...
    def create(self):
        ...
        for index, guide in enumerate(guides):
            ...
            for comp_map, loc_key, dist_key, pos, rot, movement in comp_sets:
                loc_name = limb_format(PJ, IK, f"{guide.side}_{movement}".strip("_"), guide.name_raw, item=loc_key)
                dist_name = limb_format(PJ, IK, f"{guide.side}_{movement}".strip("_"), guide.name_raw, item=dist_key)
        ...
        ik_handle_name = limb_format(PJ, IK, self.guide.side, self.guide.name_raw)
        ik_solver_name = limb_format(PJ, IK, self.guide.side, self.guide.name_raw, item="RPsolver")
