...
class LimbResultComponent:
    ...
    def create(self):
        ...
        group_name = limb_level_format(PROJECT, RESULT, self.guide.side, self.guide.name_raw, GROUP)
        ...
        for guide in self.module.guides + self.module.guides_end:
            ...
            pairblend_name = limb_level_format(PROJECT, RESULT, guide.side, guide.name_raw, level=None, item=PAIRBLEND)
            blendcolor_name = limb_level_format(
                PROJECT, RESULT, guide.side, guide.name_raw, level=None, item=SCALEBLEND
            )
