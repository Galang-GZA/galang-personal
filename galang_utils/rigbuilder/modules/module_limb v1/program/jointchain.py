...
class LimbJointChainSetup:
    ...
    def build(self):
        group_name = limb_level_format(PROJECT, self.kinematics, self.guide.side, self.guide.name_raw, GROUP, JNT)
        ...
        for g in self.module.guides + self.module.guides_end:
            ...
            joint_name = limb_joint_format(PROJECT, self.kinematics, g.side, g.name_raw, JNT)
